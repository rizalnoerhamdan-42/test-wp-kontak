...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3051934932ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test-wp&table=wp_form_kontak">`test-wp`.`wp_form_kontak`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=spring_book&table=spring_book">`spring_book`.`spring_book`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7a60453f634b374f25445f4348615c4f">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="test-wp" targettable="wp_form_kontak">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `test-wp`.`wp_form_kontak` ( `id_kontak` INT(3) NOT NULL AUTO_INCREMENT ,  `nama` VARCHAR(128) NOT NULL ,  `email` VARCHAR(128) NOT NULL ,  `pesan` VARCHAR(512) NOT NULL ,    PRIMARY KEY  (`id_kontak`)) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `wp_form_kontak`</span>
                        </div>
